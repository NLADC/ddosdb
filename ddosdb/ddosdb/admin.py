...
class MyMultiTokenAdmin(admin.ModelAdmin):
    # Overriding the MultiTokenAdmin (see unregister/register below)
    # is enough to not show an empty 'key' field and have it
    # autogenerated. Sweet!
    exclude = ['key']


admin.site.unregister(MultiToken)
admin.site.register(MultiToken, MyMultiTokenAdmin)
